...
public class MenuInferior {
	...
	public MenuInferior() {
		...
		//grisClaro = new Color(98, 101, 103  ); 
	...
	private void dibujarBarraResistencia(final Graphics g) {
		final int medidaVertical = 4;
		final int anchoTotal = 100;
		final int ancho = anchoTotal * ElementosPrincipales.jugador.getResistencia() / Jugador.RESISTENCIA_TOTAL; //MOVIMIENTO DE BARRA. EN PORCENTAJE POR BARRA = 100
		...
		DibujoDebug.dibujarString(g, "" + ElementosPrincipales.jugador.getResistencia(), anchoTotal + 45,
